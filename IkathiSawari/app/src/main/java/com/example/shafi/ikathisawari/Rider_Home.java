...
public class Rider_Home extends AppCompatActivity {
    ...
    private static final String TAG = "Rider_Home";
    ...
    private void initializeViews(){
        home_btn = (Button) findViewById(R.id.riderHome);
    }
    ...
    public void navigateToMap() {
        startActivity(new Intent(Rider_Home.this,RiderHomeMap.class));
    }

    private boolean isServicesOK() {
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(Rider_Home.this);
        if (available == ConnectionResult.SUCCESS) {
            return true;
        } else if (GoogleApiAvailability.getInstance().isUserResolvableError(available)) {
            // an error occured but we can resolve it
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(Rider_Home.this, available, ERROR_DIALOGE_REQUEST);
            dialog.show();
        } else {
